...
export type TopicLanguage = {
  question: string; basicSubject: string; preciseSubject: string; predicate: string; stance: string; hedge: string;
  reason: string; consequence: string; example: string; concession: string; counterargument: string; rebuttal: string; conclusion: string;
};
export type TopicPack = {
  ...
  counterargument: string; rebuttal: string; conclusion: string; italian: TopicLanguage;
};
